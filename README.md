(For Users) Before running the bot you must change the ' ' empty strings with some meaningful mesaages and some parts where you need to upload audio files and image files to actually make the bot run those 
